...
const SearchGifs = () => {
  ...
  function changeKeywordRandom() {
    serviceGifByKeyword(keyword, initialGifs).then((gifByKeyRandom) => {
  ...
  return (
    <div>
      ...
      <Input type="text" onChange={(e) => changeKeyword(e.target.value)} />
      <button onClick={changeKeywordRandom}>Enviar</button>
      <div
        style={{
